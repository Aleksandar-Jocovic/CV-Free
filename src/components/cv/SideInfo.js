...
const SideInfo = () => {
  ...
  const values = {
    ...
    mobile: '+323 23 23',
    email: 'mike12345678901121231234567890@gmail.com',
      ...
      <div className="links-list">
        ...
        <ul>
          <li>
            ...
            <a href="https://github.com/Aleksandar-Jocovic" rel="noreferrer" target="_blank">Github</a>
          </li>
          <li>
            {links.linkedin.icon}
            <a href={`${links.linkedin.url}`} rel="noreferrer"
              target="_blank">
              {links.linkedin.text}
            </a>
          ...
          <li>
            ...
            <a href="https://festive-kalam-61b6e7.netlify.app/" rel="noreferrer" target="_blank">
              website
            </a>
